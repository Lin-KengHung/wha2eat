...
# 中心點經緯度
center_lat = 22.99901188133954
center_lon = 120.21727629304999
search_radius = 0.07  # 半徑設置為70m
...
# 儲存所有餐廳結果
with open('NCKU_4km_rawdata_detail_0730.json', 'w', encoding='utf-8') as f:
    json.dump(list(all_places), f, ensure_ascii=False, indent=2)

# 儲存每個經緯度打到餐廳的數量
with open('api_call_info_0730.json', 'w', encoding='utf-8') as f:
